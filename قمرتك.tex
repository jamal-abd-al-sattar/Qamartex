...
\Umathchardef\ألفء = "0"1"1EE80
\Umathchardef\باءء = "0"1"1EE81
\Umathchardef\جيمء = "0"1"1EE82
\Umathchardef\دالء = "0"1"1EE83
\Umathchardef\هاءء = "0"1"1EE84
\Umathchardef\واوء = "0"1"1EE85
\Umathchardef\زايء = "0"1"1EE86
\Umathchardef\حاءء = "0"1"1EE87
\Umathchardef\طاءء = "0"1"1EE88
\Umathchardef\ياءء = "0"1"1EE89
\Umathchardef\كافء = "0"1"1EE8A
\Umathchardef\لامء = "0"1"1EE8B
\Umathchardef\ميمء = "0"1"1EE8C
\Umathchardef\نونء = "0"1"1EE8D
\Umathchardef\سينء = "0"1"1EE8E
\Umathchardef\عينء = "0"1"1EE8F
\Umathchardef\فاءء = "0"1"1EE90
\Umathchardef\صادء = "0"1"1EE91
\Umathchardef\قافء = "0"1"1EE92
\Umathchardef\راءء = "0"1"1EE93
\Umathchardef\شينء = "0"1"1EE94
\Umathchardef\تاءء = "0"1"1EE95
\Umathchardef\ثاءء = "0"1"1EE96
\Umathchardef\خاءء = "0"1"1EE97
\Umathchardef\ذالء = "0"1"1EE98
\Umathchardef\ضادء = "0"1"1EE99
\Umathchardef\ظاءء = "0"1"1EE9A
\Umathchardef\غينء = "0"1"1EE9B
...
\def\title#1#2#3{%
\def\tempa{#2}%
\def\tempr{ي}\def\tempc{و}\def\templ{ش}%
\ifx\tempa\tempr
\def\tempa{#1}%
\def\tempchapter{باب}\def\tempsection{فصل}\def\tempsubsection{مبحث}%
\ifx\tempa\tempchapter
\directlua{
local input1 =[=[\hbox to 1cm { }{\amiribf]=]   .. "\luaescapestring{\string\hyperlink{باب #3}{#3}}" .. [=[}\hfill]=]
local input2 =[=[\rathe{pageno}]=]
toc_write(input1, input2) 
}%
\vskip 2em plus 1em minus 1em%
\leftline{\amirihuge \hypertarget{باب #3}{#3}}
\vskip 1.5em plus 0.5em minus 0.5em%
\noindent%
\else\ifx\tempa\tempsection
\directlua{
local input1 =[=[\hbox to 2cm { }]=]   .. "\luaescapestring{\string\hyperlink{فصل #3}{#3}}" .. "\string\\dotfill"
local input2 =[=[\rathe{pageno}]=]
toc_write(input1, input2) 
}%
\vskip 1.5em plus 0.5em minus 0.5em%
\leftline{\amiriLarge \hypertarget{فصل #3}{#3}}
\vskip 1em plus 0.3em minus 0.3em%
\noindent%
\else\ifx\tempa\tempsubsection
\directlua{
local input1 =[=[\hbox to 3.3cm { }]=]   .. "\luaescapestring{\string\hyperlink{مبحث #3}{#3}}" .. "\string\\dotfill"
local input2 =[=[\rathe{pageno}]=]
toc_write(input1, input2) 
}%
\vskip 1em plus 0.3em minus 0.3em%
\leftline{\amirilarge \hypertarget{مبحث #3}{#3}}
\vskip 0.5em plus 0.2em minus 0.2em
\noindent%
\else
\errmessage{عنوان: العنوان غير معروف '#1'، استخدم باب، فصل، أو مبحث}%
\fi\fi\fi
\else\ifx\tempa\tempc
\def\tempa{#1}%
\def\tempchapter{باب}\def\tempsection{فصل}\def\tempsubsection{مبحث}%
...
\vskip 2em plus 1em minus 1em%
\centerline{\amirihuge \hypertarget{باب #3}{#3}}
\vskip 1.5em plus 0.5em minus 0.5em%
\noindent%
\else\ifx\tempa\tempsection
\directlua{
...
\vskip 1.5em plus 0.5em minus 0.5em%
\centerline{\amiriLarge \hypertarget{فصل #3}{#3}}
\vskip 1em plus 0.3em minus 0.3em%
\noindent%
\else\ifx\tempa\tempsubsection
\directlua{
...
\vskip 1em plus 0.3em minus 0.3em%
\centerline{\amirilarge \hypertarget{مبحث #3}{#3}}
\vskip 0.5em plus 0.2em minus 0.2em
\noindent%
\else
\errmessage{عنوان: العنوان غير معروف '#1'، استخدم باب، فصل، أو مبحث}%
...
\vskip 2em plus 1em minus 1em%
\rightline{\amirihuge \hypertarget{باب #3}{#3}}
\vskip 1.5em plus 0.5em minus 0.5em%
\noindent%
\else\ifx\tempa\tempsection
\directlua{
...
\vskip 1.5em plus 0.5em minus 0.5em%
\rightline{\amiriLarge \hypertarget{فصل #3}{#3}}
\vskip 1em plus 0.3em minus 0.3em%
\noindent%
\else\ifx\tempa\tempsubsection
\directlua{
...
\vskip 1em plus 0.3em minus 0.3em%
\rightline{\amirilarge \hypertarget{مبحث #3}{#3}}
\vskip 0.5em plus 0.2em minus 0.2em
\noindent%
\else
\errmessage{عنوان: العنوان غير معروف '#1'، استخدم باب، فصل، أو مبحث}%
\fi\fi\fi
\else
\errmessage{عنوان: المحاذاة غير معروفة '#1'، استخدم و، ش، أو ي}%
\fi\fi\fi
}
%%%%%%%%%%%%%%%%%
\let\باب=\chapter
...
\def\axiom{%
  ...
  \hypertarget{مسلَّمة \rathe{axiomcounter}}{\bigskip\noindent{\amiribi مسلَّمة \rathe{axiomcounter}: }}%
}
\let\مسلمة=\example
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%% comment: Footnotes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Umathchardef\زائد="2"1"002B
\Umathchardef\ضرب="2"1"2299
\Umathchardef\زائدةناقصة="2"1"00B1
\Umathchardef\ناقصةزائدة="2"1"2213
\let\في=\cdot
